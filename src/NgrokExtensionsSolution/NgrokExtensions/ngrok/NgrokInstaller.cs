...
namespace NgrokExtensions.Tunnels
{
    ...
    public class NgrokInstaller
    {
        ...
        /// 
        /// </summary>
        /// <returns>The full path to the ngrok executable</returns>
        //public async Task<string> InstallAsync()
        public async Task<NgrokInstallerResult> InstallAsync()
        {
            var result = new NgrokInstallerResult();
            ...
            using (var exeData = exeEntry.Open())
            {
                ...
                using (var exeFile = File.Create(ngrokPath))
                {
                    ...
                    result.ExecutablePath = ngrokPath;
                    result.Success = true;
                    //return ngrokPath;
                }
            }
